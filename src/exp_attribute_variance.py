...
OUTPUT_JSON = os.path.join("reports", "feature_metrics", "exp_attribute_variance_results_grok.json")
CHART_FILE = os.path.join("reports", "figures", "attribute_variance_chart_grok.png")

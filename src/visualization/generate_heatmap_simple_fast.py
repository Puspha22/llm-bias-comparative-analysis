...
def main():
    ...
    print("Computing co-occurrences fast for simple top 8 individual attributes...")
    ...
    plt.close()
    print("Generated simple frequency-based 4-condition attribute_pairs_heatmap_combined grid fast.")

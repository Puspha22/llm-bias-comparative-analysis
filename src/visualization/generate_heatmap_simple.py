...
def main():
    ...
    print("Computing co-occurrences for top individual attributes...")
    ...
    # Load top 8 individual attributes from frequency metrics
    ...
    # Overwrite default active asset
    ...
    plt.close()
    print("Generated simple frequency-based 4-condition attribute_pairs_heatmap_combined grid successfully.")
